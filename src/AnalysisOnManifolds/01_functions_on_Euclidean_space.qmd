...
행렬의 노름이 [거리 함수](https://julia-kaeri.github.io/MathematicalAnalysis/src/part2/2_1_basic_topology.html#def-MA_metric_space) 의 4가지 성질을 만족함을 보이면 되는데 이는 쉽게 보일 수 있다.
